...
export const COMPANY = {
  ...
  phone2: "+263 77 373 3504",
  phone2Tel: "+263773733504",
  whatsapp: "+263 77 373 3504",
  whatsappRaw: "263773733504",
...
export const KNOWLEDGE = [
  ...
  },
  {
    id: "about",
    keywords: [
      "gorudo", "about", "who", "who are you", "who is gorudo", "what is gorudo",
      "company", "background", "story", "introduction", "overview",
      "private limited", "harvesting prosperity",
    ],
    answer:
  ...
  },
  {
    id: "divisions",
    keywords: [
      "division", "divisions", "business unit", "business units", "subsidiary", "subsidiaries",
      "offer", "offerings", "service", "services", "branch", "branches",
      "product", "products", "range", "portfolio", "what do you do", "what do you offer",
    ],
    answer:
  ...
  },
  {
    id: "procurement",
    keywords: [
      "procurement", "tender", "tenders", "government", "institution", "institutional",
      "rfq", "rfp", "bid", "bids", "bidding", "supply of goods", "supplier",
      "compliance", "compliant", "praz", "contract", "contracts",
    ],
    answer:
  ...
  },
  {
    id: "location",
    keywords: [
      "location", "where", "address", "based", "office", "offices",
      "headquarters", "hq", "harare", "marondera", "chihota", "mudakurwa",
      "find", "situated", "located",
    ],
    answer:
  ...
  },
  {
    id: "contact",
    keywords: [
      "contact", "phone", "call", "email", "mail", "reach", "talk", "speak",
      "number", "whatsapp", "wa", "chat", "dm", "message", "get in touch",
    ],
    answer:
      "📞 Phone: +263 242 127233\n📞 Mobile: +263 77 373 3504\n💬 WhatsApp: +263 77 373 3504\n✉️ Email: info@gorudoinvestments.co.zw\n📍 Plot 1 Mudakurwa, Chihota, Marondera",
  },
  {
    id: "hours",
  ...
  },
  {
    ...
    answer: "Goodbye 👋 — reach us anytime on WhatsApp: +263 77 373 3504.",
  },
];
